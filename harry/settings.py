...
CORS_ALLOWED_ORIGINS = [origin.strip() for origin in os.getenv('CORS_ALLOWED_ORIGINS', 'https://legal-assistantdup-app-admin.vercel.app,http://localhost:3000,http://localhost:5173').split(',') if origin.strip()]
